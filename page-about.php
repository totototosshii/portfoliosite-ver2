        ...
        <div class="section-content">
          <div class="career">
            ...
            <dl class="career-item">
              ...
              <dd class="career-text">工業高校卒業後、地元の製造業に就職して工場勤務。<br>主に工作機械のオペレーター業務を担当し、空気圧制御機器の部品を加工。一時期は切削工具の管理と兼務して書類作成業務を行う。<br>リーマンショック回復後からは３交代勤務で主力製品の生産に携わる。</dd><!-- /.career-text -->
